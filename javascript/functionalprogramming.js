...
Window.prototype.tabClose = function(index) {
  ...
  const tabsBeforeIndex = this.tabs.slice(0, index); // Get the tabs before the tab // SLICE ADDED **
  const tabsAfterIndex = this.tabs.slice(index + 1); // Get the tabs after the tab // SLICE ADDED **
...
const nonMutatingCities = ["Chicago", "Delhi", "Islamabad", "London", "Berlin"];
nonMutatingSplice(inputCities)

// output ["Chicago", "Delhi", "Islamabad"]
